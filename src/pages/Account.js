  ...
  if (!loggedIn) {
    return (
      <div className="Account">
        <p className="account-message">Login to view this page</p><br></br>
        <button className='btn' onClick={() => handleRedirect('/login')}>
          Go to Login
        </button>
        <br />
        <br />
        <p className="account-message">New User for this page... Go to Sign up page</p><br></br>
        <button className="btn" onClick={() => handleRedirect('/signin')}>
          Go to Sign up
        </button>
      </div>
    );
